export IN=../output/archires/output_integrate/archires.ttl
export OUT=analysis/archires_integrate
mkdir -p $OUT

# 1. Generate the SHACL profile for the dataset
echo "PACTOLS - Generate the SHACL profile..."
...
echo "PACTOLS - Compute statistics..."
