...
class cleanReferentiel:
    ...
    def __init__(self,RefInformation:referentiel):
        self.RefInformation = RefInformation.Information.Information_Referentiel()
        # Create Directory Default
        self.Clean_Directory = tools.new_directory(".","Clean")
        # Logging
        self.logger = logging.getLogger(__name__)


    def read_sparql_resource(self):
        
        # Resource
        referentiel_data = self.RefInformation
